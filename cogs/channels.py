...
class Channels(commands.Cog):
    ...
    async def channelstats(self, ctx):
        """
        Sends an embed with the channel stats
        """
        channel = ctx.channel
    ...
    async def new(self, ctx):
        """
        Base commands to create a new category or channel.

        Subcommands:
            - category : Creates a discord category
            - channel : Creates a discord channel
        """
    ...
    async def channel(self, ctx, role: discord.Role, *, name):
        ...
        channel = await ctx.guild.create_text_channel(name=name, overwrites=overwrites,
                                                      category=self.bot.get_channel(709002944879656960))
